        ...
        >
          <div>
            <DragItem id="$1" left='10px' top='20px'> 
              <div className="w3-container w3-red" style={{width: '100px', height: '30px'}}> Drag Me </div> 
            </DragItem>
            <DragItem id="$2" left='10px' top='80px'> 
              <div className="w3-container w3-blue" style={{width: '100px', height: '30px'}}> Drag Me </div> 
            </DragItem>
            <DragItem id="$3" left='10px' top='140px'> 
              <div className="w3-container w3-green" style={{width: '100px', height: '30px'}}> Drag Me </div> 
            </DragItem>
          </div>
